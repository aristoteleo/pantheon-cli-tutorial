export default {
  nav: {
    ...
    installWindows: '2.3. Windows安装',
    installMacos: '2.4. macOS安装',
    installLinux: '2.5. Linux安装',
    installVerify: '2.6. 验证安装',
    basicCommands: '3. 基础命令',
    basicOverview: '3.1. 命令概述',
    basicNavigation: '3.2. 目录导航',
    basicFileOps: '3.3. 文件操作',
    basicTextEdit: '3.4. 文本编辑',
    basicPermissions: '3.5. 权限管理',
