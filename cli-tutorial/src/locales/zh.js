export default {
  nav: {
    ...
    introWhatIs: '什么是CLI',
    introWhy: '为什么使用CLI',
    introGettingStarted: '快速开始',
    installation: '安装',
    installOverview: '安装概述',
    installRequirements: '系统要求',
    installWindows: 'Windows安装',
    installMacos: 'macOS安装',
    installLinux: 'Linux安装',
    installVerify: '验证安装',
    basicCommands: '基础命令',
    basicOverview: '命令概述',
    basicNavigation: '目录导航',
    basicFileOps: '文件操作',
    basicTextEdit: '文本编辑',
    basicPermissions: '权限管理',
    advancedUsage: '高级用法',
    advancedOverview: '高级功能概述',
    advancedScripting: '脚本编写',
    advancedPipes: '管道和重定向',
    advancedRegex: '正则表达式',
    advancedAutomation: '自动化任务',
    troubleshooting: '故障排除',
    troubleOverview: '常见问题概述',
