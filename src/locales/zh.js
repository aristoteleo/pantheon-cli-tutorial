export default {
  nav: {
    ...
    realCases: '5. 真实案例',
    caseSeuratLlmAnnotation: '5.1. 生物学: Seurat与自然语言混合注释',
    caseSocialBehavior: '5.2. 社会学: 问卷调查分析',
    caseCustomsFinance: '5.3. 金融学: 目标客户分析',
    caseScRnaComplex: '5.4. 生物学: 复杂单细胞RNA-seq注释',
    caseScLlm: '5.5. 生物学: 从在线教程自动学习与调用单细胞LLM',
    caseHd10x: '5.6. 生物学: 10x Genomics HD Visium细胞分割',
    caseAtacUpstream: '5.7. 生物学: ATAC-seq上游处理',
    caseRnaUpstream: '5.8. 生物学: RNA-seq上游处理',
    caseMolecularDocking: '5.9. 生物学: 分子对接与结构分析',
    caseMixedPythonR: '5.10. Python与R混合编程',
