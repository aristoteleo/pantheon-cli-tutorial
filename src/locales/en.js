export default {
  nav: {
    ...
    installVerify: '2.6. Verify Installation',
    ...
    caseSocialBehavior: '5.1. Sociology: Survey Analysis',
    caseCustomsFinance: '5.2. Finance: Target Customer Analysis',
    caseScRnaComplex: '5.3. Biology: Complex Single-cell RNA-seq Annotation',
    caseScLlm: '5.4. Biology: Auto-learning Single-cell LLM from Online Tutorials',
    caseHd10x: '5.5. Biology: 10x Genomics HD Visium Cell Segmentation',
    caseAtacUpstream: '5.6. Biology: ATAC-seq Upstream Processing',
    caseRnaUpstream: '5.7. Biology: RNA-seq Upstream Processing',
    caseMolecularDocking: '5.8. Biology: Molecular Docking & Structure Analysis',
    caseMixedPythonR: '5.9. Python & R Mixed Programming',
    caseSeuratLlmAnnotation: '5.10. Biology: Seurat & Natural Language Mixed Annotation',
